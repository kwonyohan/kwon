...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.hexview.setGeometry(QtCore.QRect(30, 40, 371, 421))
        self.hexview.setObjectName("hexview")
        self.viewtxt = QtWidgets.QTextBrowser(self.centralwidget)
        self.viewtxt.setGeometry(QtCore.QRect(420, 40, 351, 511))
        self.viewtxt.setObjectName("viewtxt")
        self.console = QtWidgets.QTextBrowser(self.centralwidget)
        self.console.setGeometry(QtCore.QRect(30, 490, 371, 61))
        self.console.setObjectName("console")
        self.console_label = QtWidgets.QLabel(self.centralwidget)
        self.console_label.setGeometry(QtCore.QRect(30, 470, 77, 18))
        font = QtGui.QFont()
        ...
        self.tabWidget.setGeometry(QtCore.QRect(410, 10, 371, 551))
